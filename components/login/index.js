...
const LoginPage = () => {
    ...
    return (
        <div className='w-full flex flex-row mt-20 py-8 space-x-4 justify-center font-poppins'>
            <div className="max-w-lg space-y-4 flex flex-col justify-center bg-white font-poppins">
                <div className='flex flex-col space-y-2'>
                    <div className="flex flex-row items-center justify-center">
                        <span className="text-black font-bold text-4xl text-center">Welcome back!</span>
                    </div>
                </div>
                {/* <div className='flex flex-col space-y-2'>
                    <div className="flex flex-row items-center justify-center">
                        <span className="text-black font-normal text-lg">Masuk ke akun loker kamu</span>
                    </div>
                    <div className="w-full h-px bg-gray-500"></div>
                </div> */}
                <div className="flex flex-col space-y-6">
                    <span className="text-black text-lg text-center">Masuk ke akun loker kamu.</span>
